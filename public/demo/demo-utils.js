...
function Cursor({ t, keyframes, scale = 1 }) {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "click-ring", ref: ringRef }), /* @__PURE__ */ React.createElement("div", { className: "cursor", style: {
    left: state.x + "px",
    top: state.y + "px",
    opacity: state.hide ? 0 : 1,
    transform: `translate(-2px, -2px) scale(${scale})`
  } }, /* @__PURE__ */ React.createElement("svg", { viewBox: "0 0 22 28", fill: "none" }, /* @__PURE__ */ React.createElement(
    "path",
    {
      d: "M2 2 L2 22 L7 17 L10.5 25 L13 24 L9.5 16 L17 16 Z",
      fill: "#2a2418",
      stroke: "#f4ecd6",
      strokeWidth: "1.4",
...
function FlashAt({ t, when, x, y, color = "#6c8a1f" }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: {
    ...
    transform: `translate(-50%, -50%) scale(${0.4 + u * 1})`,
    opacity: 1 - u,
    pointerEvents: "none",
    zIndex: 99
  } });
